-- Update and complete analyses table structure
-- Create additional tables that might be missing

-- Analysis versions table for history tracking
...
-- Analysis jobs table for execution tracking
...
-- Analysis results storage table for metadata
...
-- Add triggers for updated_at on schedules table
...
DROP TRIGGER IF EXISTS update_analysis_schedules_updated_at ON analysis_schedules;
