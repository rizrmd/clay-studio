...
import { projectsStore, projectsActions } from "@/lib/store/projects-store";
...
export function ProjectsPage() {
  ...
  return (
    <AppLayout>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-blue-300 dark:border-blue-600">
                    <div className="p-6">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          projectsActions.setNewProjectName(e.target.value)
                        }
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          disabled={
                            projectsSnapshot.isLoading ||
                            !projectsSnapshot.newProjectName.trim()
                          }
      ...
      <Dialog
        open={projectsSnapshot.deleteDialogOpen}
        onOpenChange={projectsActions.setDeleteDialogOpen}
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {projectsSnapshot.projectToDelete?.name}"? This action cannot be
              undone. All conversations and data sources associated with this
