...
try {
  ...
  await $`docker run -d --name clay-studio -p 3000:7680 --restart unless-stopped -e DATABASE_URL=postgres://postgres:hltsXdfWOOGNkd32xsMbzp6bgBXPzPCiob6UEH0XL3qSt9OuqvEyhN0o3gZNSjuY@107.155.75.50:5389/clay-studio -e RUST_ENV=production -e RUST_LOG=debug -e STATIC_FILES_PATH=/app/frontend/dist ${imageUrl}`;
